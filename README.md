...
- [libghostty-vaxis](https://github.com/rockorager/libghostty-vaxis) - libghostty integration for the Vaxis Go TUI library.
...
- [ZenTerm](https://github.com/praxis-labs-io/zen-term) - A macOS terminal for developers with tiled panes, drawers, tool floats, and workspaces.
...
- [Godotty](https://github.com/ingur/godotty) - A terminal emulator for the Godot Engine, written in Rust and powered by libghostty-vt.
...
- [Calyx](https://github.com/yuuichieguchi/Calyx) - A native macOS terminal for supervising coding agents in parallel.
...
- [Nexion](https://nexion.one) - A native macOS workspace built on libghostty, with saved terminal layouts, a built-in browser, git, and an iPhone companion.
- [paulatty](https://github.com/lancy/paulatty) - An AI agent team workspace built on libghostty.
- [PonyMux](https://github.com/heylittlepan/ponymux) - Native macOS terminal for organizing, resuming, and forking Claude Code and Codex sessions.
...
- [witty](https://github.com/milesxu/witty) - AI-powered terminal emulator built with Python, Qt6, and Rust.
...
- [headless-terminal](https://github.com/montanaflynn/headless-terminal) - Puppeteer for TUIs (vim/emacs/htop/nethack) with a Go CLI backed by libghostty-vt.
...
- [term2html](https://github.com/aarol/term2html) - A terminal output (ANSI) to HTML converter that respects your terminal colors, built with libghostty-vt.
