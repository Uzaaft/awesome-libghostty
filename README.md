...
- [Nexion](https://nexion.one) - The AI-native macOS workspace. Built on Ghostty for the terminal, with visual tmux, remote SSH, savable Workspaces, a built-in browser, Git, plugins, a CLI, and Claude Code and Codex as first-class citizens.
